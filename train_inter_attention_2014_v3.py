...
tf.app.flags.DEFINE_string('train_fname', 'data/Restaurants_Train_v2.xml', 'training file name')
tf.app.flags.DEFINE_string('test_fname', 'data/Restaurants_Test_Gold.xml', 'testing file name')
tf.app.flags.DEFINE_string('data_info', 'data/data_info_ram_2014.txt', 'the file saving data information')
tf.app.flags.DEFINE_string('train_data', 'data/train_data_ram_2014.txt', 'the file saving training data')
tf.app.flags.DEFINE_string('test_data', 'data/test_data_ram_2014.txt', 'the file saving testing data')
