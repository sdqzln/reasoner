...
tf.app.flags.DEFINE_string('train_fname', 'data/ABSA16_Restaurants_Train_SB1_v2.xml', 'training file name')
tf.app.flags.DEFINE_string('test_fname', 'data/EN_REST_SB1_TEST.xml.gold', 'testing file name')
tf.app.flags.DEFINE_string('data_info', 'data/data_info_ram_2016.txt', 'the file saving data information')
tf.app.flags.DEFINE_string('train_data', 'data/train_data_ram_2016.txt', 'the file saving training data')
tf.app.flags.DEFINE_string('test_data', 'data/test_data_ram_2016.txt', 'the file saving testing data')
