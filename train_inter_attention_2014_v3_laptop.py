...
from data_utils_14 import get_data_info, read_data, load_word_embeddings
...
tf.app.flags.DEFINE_string('train_fname', 'data/Laptops_Train.xml', 'training file name')
tf.app.flags.DEFINE_string('test_fname', 'data/Laptops_Test_Gold.xml', 'testing file name')
tf.app.flags.DEFINE_string('data_info', 'data/data_info_ram_2014_laptop.txt', 'the file saving data information')
tf.app.flags.DEFINE_string('train_data', 'data/train_data_ram_2014_laptop.txt', 'the file saving training data')
tf.app.flags.DEFINE_string('test_data', 'data/test_data_ram_2014_laptop.txt', 'the file saving testing data')
